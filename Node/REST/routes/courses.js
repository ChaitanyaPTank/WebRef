...
router.get('/',(req, res) => { // route.get('/') = route.get('/api/courses/')
    res.send(courses);
});

router.get('/:id',(req, res) =>{ // or we can use /api/courses/:year/:month to get two params
...
router.post('/', (req, res) => { // using post method don't get confused with route.get('/', (req, res) => body )
